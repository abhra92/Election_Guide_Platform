      ...
      <div className="max-w-[1280px] mx-auto px-4 sm:px-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 mb-[60px]">
          <div className="col-span-1 lg:col-span-1">
            <h4 className="text-[24px] font-[360] text-foreground mb-6" style={{ fontFamily: "var(--font-display)" }}>Election Guide</h4>
            <p className="text-[16px] text-muted-foreground leading-relaxed" style={{ fontFamily: "var(--font-body)" }}>
              An interactive educational resource helping Indian citizens understand the democratic process and their voting rights.
            </p>
          </div>
          
          <div>
            <h4 className="text-[14px] font-[500] text-foreground uppercase tracking-widest mb-6">Quick Links</h4>
            <ul className="space-y-4 text-[16px] text-muted-foreground" style={{ fontFamily: "var(--font-body)" }}>
          ...
          <div>
            <h4 className="text-[14px] font-[500] text-foreground uppercase tracking-widest mb-6">Connect</h4>
            <div className="flex flex-wrap gap-4">
              ...
              <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-secondary flex items-center justify-center text-muted-foreground hover:bg-neon-green hover:text-background transition-all duration-300 shadow-shopify" title="LinkedIn">
          ...
          <div>
            <h4 className="text-[14px] font-[500] text-foreground uppercase tracking-widest mb-6">Disclaimer</h4>
            <p className="text-[14px] text-muted-foreground leading-relaxed" style={{ fontFamily: "var(--font-body)" }}>
