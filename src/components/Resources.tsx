      ...
      <div className="max-w-[1280px] mx-auto px-4 sm:px-8">
          ...
          {resources.map((resource, index) => {
            ...
            return (
              ...
              >
                ...
                <h3 className="text-[24px] font-[360] text-foreground mb-3" style={{ fontFamily: "var(--font-display)" }}>{resource.title}</h3>
                <p className="text-[16px] text-muted-foreground leading-relaxed mb-8" style={{ fontFamily: "var(--font-body)" }}>{resource.description}</p>
        ...
        <div className="mt-[80px] grid grid-cols-1 md:grid-cols-2 gap-[32px]">
          <div className="bg-card rounded-[20px] border border-border p-8 shadow-shopify hover:border-neon-green/30 transition-all duration-300">
            <div className="flex items-center gap-4 mb-6">
              ...
              <h3 className="text-[28px] font-[360] text-foreground" style={{ fontFamily: "var(--font-display)" }}>National Voter Helpline</h3>
            </div>
            <p className="text-[18px] text-muted-foreground mb-6" style={{ fontFamily: "var(--font-body)" }}>
            ...
            <div className="flex items-center gap-4 p-4 bg-secondary rounded-[12px] border border-border">
              <span className="text-[32px] font-[500] text-neon-green" style={{ fontFamily: "var(--font-display)" }}>1950</span>
          ...
          <div className="bg-card rounded-[20px] border border-border p-8 shadow-shopify hover:border-neon-green/30 transition-all duration-300">
            <div className="flex items-center gap-4 mb-6">
              ...
              <h3 className="text-[28px] font-[360] text-foreground" style={{ fontFamily: "var(--font-display)" }}>Voter Helpline App</h3>
            </div>
            <p className="text-[18px] text-muted-foreground mb-6" style={{ fontFamily: "var(--font-body)" }}>
        ...
        <div className="mt-[120px] relative rounded-[32px] overflow-hidden bg-secondary border border-border p-8 sm:p-20 text-center">
          ...
          <div className="relative z-10">
            <h3 className="text-[40px] sm:text-[55px] font-[330] leading-[1.1] text-foreground mb-6" style={{ fontFamily: "var(--font-display)" }}>
              Ready to Make Your Voice Heard?
            </h3>
            <p className="text-[20px] text-muted-foreground max-w-2xl mx-auto mb-10" style={{ fontFamily: "var(--font-body)" }}>
