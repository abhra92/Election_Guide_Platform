      ...
      <div className="max-w-[1024px] mx-auto px-4 sm:px-8">
            ...
            return (
              ...
              >
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <span className="text-[28px] sm:text-[34px] md:text-[40px] font-[360] text-muted-foreground opacity-50" style={{ fontFamily: "var(--font-display)" }}>
                    {String(step.step).padStart(2, "0")}
                  </span>
                </div>

                <h3 className="text-[20px] sm:text-[22px] md:text-[24px] font-[360] leading-[1.2] tracking-[0.32px] text-foreground mb-3" style={{ fontFamily: "var(--font-display)" }}>{step.title}</h3>
                <p className="text-[14px] sm:text-[15px] md:text-[16px] font-[400] leading-[1.50] text-muted-foreground mb-6" style={{ fontFamily: "var(--font-body)" }}>{step.description}</p>

                <div className="pt-6 border-t border-border">
                  <h4 className="text-[12px] sm:text-[13px] md:text-[14px] font-[500] text-neon-green uppercase tracking-[0.28px] mb-3" style={{ fontFamily: "var(--font-body)" }}>
                    Helpful Tips
                  </h4>
                  <ul className="space-y-3">
                    {step.tips.map((tip, i) => (
                      <li key={i} className="flex items-start gap-3 text-[14px] sm:text-[15px] md:text-[16px] font-[400] text-muted-foreground" style={{ fontFamily: "var(--font-body)" }}>
        ...
        <div>
          <div className="text-center mb-[64px]">
            <h3 className="text-[28px] sm:text-[34px] md:text-[40px] font-[330] leading-[1.16] tracking-tight text-foreground mb-4" style={{ fontFamily: "var(--font-display)" }}>Key Election Dates</h3>
            <p className="text-[15px] sm:text-[16px] md:text-[18px] font-[400] leading-[1.56] text-muted-foreground" style={{ fontFamily: "var(--font-body)" }}>Important milestones to mark on your calendar</p>
          </div>
            ...
            {keyDates.map((item, index) => {
              ...
              return (
                ...
                >
                  ...
                  <h4 className="text-[16px] sm:text-[17px] md:text-[18px] font-[500] text-foreground mb-2" style={{ fontFamily: "var(--font-body)" }}>{item.event}</h4>
                  <p className="text-[13px] sm:text-[14px] font-[400] leading-[1.50] text-muted-foreground" style={{ fontFamily: "var(--font-body)" }}>{item.timing}</p>
                </div>
